"""19.7.2 Написание автотестов для RESTful сервисов"""
import json
import requests
...
class PetFriends:
    ...
    def post_create_pet_simple(self, auth_key, name: str, animal_type: str, age: str) -> json:
    ...
    def get_api_key(self, email, password: str) -> json:
        ...
        JSON с уникальным ключем пользователя, найденного по указаным email и password'''
    ...
    def post_pets_set_photo(self, auth_key, pet_id: str, pet_photo) -> json:
        """Post запрос создающий фото для питомца на сайте"""
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str,
        ...
        '''Метод отправляет запрс на сервер об обновлении данных питомца по указанному ID
         и возвращает статус питомца и result в формате JSON с обновленными данными питомца'''
